...
export const speakers: Speaker[] = [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    bio: "Peter Norvig, a distinguished American computer scientist, is widely recognized for his profound contributions to artificial intelligence and education. He served as the Director of Research at Google and was previously the head of the Computational Sciences Division at NASA Ames Research Center. Norvig is co-author of the leading textbook 'Artificial Intelligence: A Modern Approach' and has been instrumental in advancing AI research and applications.",
    programs: [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    bio: "Dr. Daniel Kraft is a physician-scientist, inventor, and entrepreneur focused on the convergence of medicine and exponential technologies. He is the founder of NextMed Health and has been at the forefront of digital health innovation. Kraft combines medical expertise with technology insights to help healthcare organizations leverage AI and digital tools.",
    programs: [
    ...
    website: "https://danielkraftmd.net/",
    email: "daniel.kraft@gmail.com",
    contact: "Direct",
    listed: true,
    expertise: ["Digital Health", "AI in Medicine", "Healthcare Innovation", "Medical Technology"],
    industries: ["Healthcare", "Pharmaceuticals", "Medical Devices", "Biotechnology"],
    ranking: 82,
  },
  {
    slug: "charlene-li",
  ...
  },
  {
    slug: "jamie-metzl",
    name: "Jamie Metzl",
    title: "Geopolitical Expert & AI Policy Advisor",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Jamie Metzl is a leading geopolitical expert, technology futurist, and former National Security Council staff member. He advises governments and organizations on AI policy, genetic engineering, and emerging technologies. Metzl is a bestselling author and frequent media commentator on the intersection of technology and global affairs.",
    programs: [
      "AI Geopolitics and Global Competition",
    ...
    fee: "Please Inquire",
    location: "Global",
    linkedin: "https://www.linkedin.com/in/jamie-metzl-8a4a3610/",
    email: "jamiemetzl@gmail.com",
    contact: "Direct",
    listed: true,
    expertise: ["AI Policy", "Geopolitics", "Technology Regulation", "National Security"],
    industries: ["Government", "Policy", "Defense", "International Relations"],
    ranking: 68,
  },
  {
    slug: "chris-yeh",
  ...
  },
  {
    slug: "reza-zadeh",
    name: "Reza Zadeh",
    title: "Stanford Professor & AI Research Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Reza Zadeh is a Professor at Stanford University and a leading AI research expert specializing in machine learning and distributed computing. He has made significant contributions to large-scale machine learning and AI research.",
    programs: [
      "Large-Scale Machine Learning",
      "Distributed AI Systems",
      "AI Research and Development",
      "Academic-Industry AI Collaboration",
    ],
    fee: "$40k-$60k",
    location: "Stanford, CA",
    email: "reza@stanford.edu",
    contact: "University",
    listed: true,
    expertise: ["Machine Learning", "Distributed Computing", "AI Research", "Academic Research"],
    industries: ["Education", "Research", "Technology", "Academia"],
    ranking: 62,
  },
  {
    slug: "sharon-zhou",
    name: "Sharon Zhou",
    title: "AI Researcher & Stanford Lecturer",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Sharon Zhou is an AI researcher and lecturer at Stanford University, specializing in machine learning and computer vision. She has made significant contributions to AI research and is passionate about making AI education accessible to diverse audiences.",
    programs: [
    ...
    fee: "$35k-$50k",
    location: "Stanford, CA",
    email: "sharon@stanford.edu",
    contact: "University",
    listed: true,
    expertise: ["Machine Learning", "Computer Vision", "AI Research", "AI Education"],
    industries: ["Education", "Research", "Technology", "Academia"],
    ranking: 60,
  },
  {
    slug: "gopi-kallayil",
    name: "Gopi Kallayil",
    title: "Former Google Brand Marketing Executive",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Gopi Kallayil is a former Google executive, author, and digital transformation expert. During his time at Google, he led marketing initiatives for Google+ and other major products. He's an expert in digital transformation, AI marketing, and technology adoption, helping organizations navigate the intersection of technology and human behavior.",
    programs: [
      "Digital Transformation in the AI Era",
      "AI-Powered Marketing Strategies",
      "Technology Adoption and Change Management",
      "Innovation Culture in Large Organizations",
    ],
    fee: "$25k-$50k",
    location: "SF/Bay Area",
    linkedin: "https://www.linkedin.com/in/gopikallayil/",
    email: "yogaps@gmail.com",
    contact: "Direct",
    listed: true,
    expertise: ["Digital Transformation", "AI Marketing", "Technology Adoption", "Innovation"],
    industries: ["Technology", "Marketing", "Media", "Retail"],
    ranking: 97,
  },
  {
    slug: "jeremiah-owyang",
    name: "Jeremiah Owyang",
    title: "Technology Analyst & AI Industry Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Jeremiah Owyang is a renowned technology analyst and AI industry expert who provides insights into emerging technology trends and their business implications. He has extensive experience in technology research and industry analysis.",
    programs: [
    ...
    fee: "$35k-$50k",
    location: "San Francisco",
    linkedin: "https://www.linkedin.com/in/jeremiah/",
    email: "jeremiah@techanalysis.com",
    contact: "Direct",
    listed: true,
    expertise: ["Technology Analysis", "AI Industry Research", "Market Trends", "Digital Strategy"],
    industries: ["Technology", "Research", "Consulting", "Media"],
    ranking: 55,
  },
  {
    slug: "sounil-yu",
  ...
  {
    slug: "christopher-helms-ategeka",
    name: "Christopher Helms Ategeka",
    title: "AI for Social Good & Technology Innovation Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Christopher Helms Ategeka is a technology innovation expert focused on using AI for social good and global development. He has extensive experience in applying artificial intelligence to solve real-world problems in developing countries and underserved communities.",
    programs: [
      "AI for Social Good and Global Development",
      "Technology Innovation in Emerging Markets",
      "Ethical AI Implementation",
      "Digital Inclusion and AI Access",
    ],
    fee: "$25k-$40k",
    location: "Global",
    email: "christopher@socialai.org",
    contact: "Direct",
    listed: true,
    expertise: ["AI for Social Good", "Global Development", "Technology Innovation", "Digital Inclusion"],
    industries: ["Non-profit", "International Development", "Technology", "Social Impact"],
    ranking: 42,
  },
  {
    slug: "alex-salkever",
  ...
  },
  {
    slug: "gary-bolles",
    name: "Gary Bolles",
    title: "Future of Work Expert & AI Impact Specialist",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Gary Bolles is a leading expert on the future of work and the impact of AI on employment and society. He helps organizations and individuals navigate the changing landscape of work in the age of artificial intelligence and automation.",
    programs: [
      "The Future of Work in the AI Era",
    ...
    contact: "Direct",
    listed: true,
    expertise: ["Future of Work", "AI Impact", "Workforce Development", "Economic Transformation"],
    industries: ["Human Resources", "Education", "Government", "Consulting"],
    ranking: 38,
  },
  {
    slug: "aviv-ovadya",
    name: "Aviv Ovadya",
    title: "AI Safety & Misinformation Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Aviv Ovadya is a leading expert in AI safety and misinformation, focusing on the societal risks of artificial intelligence and digital platforms. He works on developing solutions to prevent AI-powered misinformation and ensuring AI systems are aligned with human values.",
    programs: [
      "AI Safety and Alignment",
      "Combating AI-Powered Misinformation",
      "Digital Platform Governance",
      "Responsible AI Development",
    ],
    fee: "$30k-$45k",
    location: "Boston, MA",
    email: "aviv@aisafety.org",
    contact: "Direct",
    listed: true,
    expertise: ["AI Safety", "Misinformation", "Digital Governance", "AI Ethics"],
    industries: ["Technology", "Media", "Government", "Research"],
    ranking: 35,
  },
  {
    slug: "nancy-xu",
  ...
  },
  {
    slug: "vishal-sharma",
    name: "Vishal Sharma",
    title: "AI Enterprise Solutions & Digital Transformation Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Vishal Sharma is an AI enterprise solutions and digital transformation expert who helps large organizations implement AI at scale. He has extensive experience in enterprise AI architecture and digital transformation strategies.",
    programs: [
      "Enterprise AI Implementation",
      "Digital Transformation with AI",
    ...
    fee: "$35k-$50k",
    location: "New York",
    email: "vishal@enterpriseai.com",
    contact: "Direct",
    listed: true,
    expertise: ["Enterprise AI", "Digital Transformation", "AI Architecture", "Technology Strategy"],
    industries: ["Enterprise", "Technology", "Consulting", "Finance"],
    ranking: 98,
  },
  {
  ...
  },
  {
    slug: "ted-selker",
    name: "Ted Selker",
    title: "Former MIT Professor & Human-Computer Interaction Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Ted Selker is a renowned expert in human-computer interaction and former MIT professor. He has been instrumental in developing innovative interfaces and AI systems that enhance human productivity. Selker's work focuses on making technology more intuitive and accessible through intelligent design and AI-powered interfaces.",
    programs: [
      "Human-Computer Interaction in the AI Age",
    ...
    fee: "$25k-$40k",
    location: "Boston, MA",
    email: "ted@selker.com",
    contact: "Direct",
    listed: true,
    expertise: ["Human-Computer Interaction", "Interface Design", "AI UX", "Technology Innovation"],
    industries: ["Technology", "Design", "Education", "Research"],
    ranking: 1,
  },
  // Additional speakers with lower rankings...
  {
  ...
  },
  {
    slug: "lucien-engelen",
    name: "Lucien Engelen",
    title: "Digital Health & AI Healthcare Innovation Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Lucien Engelen is a digital health and AI healthcare innovation expert who specializes in transforming healthcare through technology. He has extensive experience in healthcare innovation and AI applications in medical practice.",
    programs: [
      "Digital Health Innovation and AI",
      "Healthcare Transformation with Technology",
      "AI in Medical Practice",
      "The Future of Healthcare Technology",
    ],
    fee: "$35k-$50k",
    location: "Netherlands",
    email: "lucien@digitalhealthai.com",
    contact: "Direct",
    listed: true,
    expertise: ["Digital Health", "Healthcare Innovation", "Medical AI", "Healthcare Technology"],
  ...
  },
  {
    ...
    title: "AI Healthcare & Medical Technology Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Julie Holmes is an AI healthcare and medical technology expert who specializes in the implementation of artificial intelligence in healthcare settings. She has extensive experience in healthcare AI and medical technology innovation.",
    programs: [
    ...
    fee: "$35k-$50k",
    location: "Boston, MA",
    email: "julie@healthcareai.com",
    contact: "Direct",
    listed: true,
    expertise: ["Healthcare AI", "Medical Technology", "Digital Health", "Healthcare Innovation"],
    industries: ["Healthcare", "Medical Technology", "Digital Health", "AI"],
    ranking: 13,
  },
  {
  ...
  },
  {
    slug: "tiarne-hawkins",
    name: "Tiarne Hawkins",
    title: "AI Education & Learning Technology Expert",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Tiarne Hawkins is an AI education and learning technology expert who specializes in the application of artificial intelligence in educational settings. She has extensive experience in educational technology and AI-powered learning systems.",
    programs: [
    ...
    fee: "$30k-$45k",
    location: "Australia",
    email: "tiarne@aieducation.com",
    contact: "Direct",
    listed: true,
    expertise: ["AI Education", "Educational Technology", "Learning Systems", "AI in Schools"],
    industries: ["Education", "EdTech", "Technology", "Learning"],
    ranking: 1,
  },
]
