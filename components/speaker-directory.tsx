      ...
      <CardContent className="p-0">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col gap-3">
            <Button
              asChild
              className="w-full bg-gradient-to-b from-amber-400 via-amber-500 to-amber-600 hover:from-amber-500 hover:via-amber-600 hover:to-amber-700 text-white border-0 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 font-montserrat font-semibold py-3 h-auto"
              style={{
                boxShadow:
            ...
            <Button
              asChild
              className="w-full border-2 border-[#1E68C6] text-[#1E68C6] hover:bg-[#1E68C6] hover:text-white font-montserrat shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 bg-white hover:border-[#1E68C6] font-semibold py-3 h-auto"
              style={{
