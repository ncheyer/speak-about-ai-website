  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-50 to-white py-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-8 font-neue-haas">Our Services</h1>
        <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-montserrat">
          At Speak About AI, we connect you with world-class AI experts to amaze your attendees, educate your
          executives, and inspire innovation. Our comprehensive range of services ensures you can leverage AI insights
          in the format that best suits your needs.
        </p>
      </div>
    </section>
  )
