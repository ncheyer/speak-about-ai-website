...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-[#1E68C6] text-white hover:bg-[#5084C6] shadow-md hover:shadow-lg transform hover:scale-105",
        gold: "bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0 shadow-md hover:shadow-lg hover:from-amber-600 hover:to-orange-600 transform hover:scale-105",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-sm hover:shadow-md transform hover:scale-105",
        outline:
          "border-2 border-blue-500 text-blue-600 bg-white shadow-sm hover:shadow-md hover:bg-blue-500 hover:text-white transform hover:scale-105",
        secondary:
