...
export default function HealthcareAISpeakersPage() {
  const healthcareSpeakers = getSpeakersByIndustry("Healthcare")
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <Button asChild className="w-full bg-[#1E68C6] hover:bg-[#5084C6]">
                <Link href="/contact">Book a Healthcare AI Speaker</Link>
              </Button>
            </div>
          </div>
        </div>
