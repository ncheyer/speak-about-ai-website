...
export default async function TechnologyKeynoteSpeakersPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[#1E68C6] hover:bg-[#1557A5] text-white px-8 py-3">
                Book Technology Speakers
              </Button>
              <Button
                variant="outline"
                size="lg"
                className="border-[#1E68C6] text-[#1E68C6] hover:bg-[#1E68C6] hover:text-white px-8 py-3"
              >
                View All Speakers
              </Button>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="text-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                <industry.icon className="w-8 h-8 text-[#1E68C6] mx-auto mb-2" />
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#1E68C6] to-[#5084C6]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-[#1E68C6] hover:bg-gray-100 px-8 py-3">
              Get Speaker Recommendations
            </Button>
            <Button
              variant="outline"
              size="lg"
              className="border-white text-white hover:bg-white hover:text-[#1E68C6] px-8 py-3"
            >
              Browse All Technology Speakers
            </Button>
          </div>
        </div>
      </section>
