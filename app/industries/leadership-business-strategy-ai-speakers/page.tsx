...
export const metadata: Metadata = {
  ...
  description:
    "Book leadership & business strategy AI keynote speakers for corporate events. Experts on AI transformation, digital leadership & strategic innovation.", // 146 chars
  keywords:
  ...
  openGraph: {
    ...
    description:
      "Book leadership & business strategy AI keynote speakers. Experts on AI transformation, digital leadership, and strategic innovation for your events.", // 148 chars
    type: "website",
  },
}
